...
t = t.replace('<div class="note">tool-name v1.0.0 &middot;', '<div class="note noprint">break-glass v1.1.0 &middot;')

t = t.replace('const APP = { id: "tool-name", version: "1.0.0", schema: 1 };',
              'const APP = { id: "break-glass", version: "1.1.0", schema: 1 };')
t = t.replace('const TABS = [["work", "pane-work"], ["about", "pane-about"]];',
              'const TABS = [["play", "pane-play"], ["debrief", "pane-debrief"], ["history", "pane-history"], ["about", "pane-about"]];')
# drop fname (depends on template meta) and everything from csv onwards, keep helpers
t = re.sub(r"const fname = .*?\n", "", t)
a = t.index("/* ---------- csv ---------- */")
b = t.index("</script>")
code = "\n".join(src(f) for f in ["data_core.js", "data_injects.js", "data_scen1.js", "data_scen2.js", "data_scen3.js", "data_scen4.js", "engine.js", "ui.js"])
t = t[:a] + code + "\n" + t[b:]
